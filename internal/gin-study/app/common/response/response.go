...
func Fail(c *gin.Context, statusCode int, errorCode int, msg string) {
...
func FailByError(c *gin.Context, error global.CustomError) {
	Fail(c, http.StatusInternalServerError, error.ErrorCode, error.ErrorMsg)
}

// ValidateFail 请求参数验证失败
func ValidateFail(c *gin.Context, msg string) {
	Fail(c, http.StatusBadRequest, global.Errors.ValidateError.ErrorCode, msg)
}

// BusinessFail 业务逻辑失败
func BusinessFail(c *gin.Context, msg string) {
	Fail(c, http.StatusInternalServerError, global.Errors.BusinessError.ErrorCode, msg)
}
